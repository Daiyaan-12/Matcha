...
<div class="form">
    <form action="./includes/updatebio.inc.php" method="POST" align="center">
        <h2> Personalize Your Choices</h2>
            ...
            <label for="gender"> I identify as: </label> <br/>
                <div>
        ...
        <textarea maxlength="300" placeholder="Let everyone know a litte bit about YOU. <max 300 characters>" name="bio"></textarea>
        <br>
